/**
 * @file fileAttachments.js
 * @description Utility functions for handling file attachments, MIME types, and file icons
 * @module utils/fileAttachments
 */

/**
 * MIME type to icon mapping
 * Maps common MIME types to standardized icon names
 ...
 * Maps common file extensions to standardized icon names
 * @constant {Object.<string, string>}
 */
...
/**
 * File icon display labels
 * Short labels displayed on file type icons
 * @constant {Object.<string, string>}
 */
